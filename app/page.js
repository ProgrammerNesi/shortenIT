...
export default function Home() {
  return (
    <div className="flex">
      <main className="bg-[#FAF9EE] min-h-screen flex md:flex-row flex-col md:justify-between md:gap-14 w-full text-[#B3A696]">
        <div className="container mx-auto md:px-18 flex flex-col gap-6 md:w-1/2 w-70 md:py-32 py-12">
          ...
          <div className="buttons flex gap-2 ">
            ...
            <Link href={"/github"}><button type="button" className="text-white bg-[#DCCFC0] hover:bg-[#e1c8aa] focus:outline-none font-medium rounded-lg text-sm px-3 py-2 text-center me-2 mb-2 cursor-pointer"> <FontAwesomeIcon icon={faGithub} /> Github</button></Link>
          </div>

        </div>
        <div className="md:py-22  px-12">
          <img src="./social.png" alt="df" width={700} />
        </div>
      </main>
    </div>
  );
